...
- Установленные TCP-туннели не мигрируют, и SOCKS5 TCP не выполняет прозрачный повторный dial через другой uplink во время ожидания первого байта ответа от upstream.
