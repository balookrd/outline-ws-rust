...
pub(in crate::tcp) fn seq_gt(lhs: u32, rhs: u32) -> bool {
    (lhs.wrapping_sub(rhs) as i32) > 0
}

pub(in crate::tcp) fn seq_ge(lhs: u32, rhs: u32) -> bool {
    !seq_lt(lhs, rhs)
}

pub(in crate::tcp) fn timestamp_lt(lhs: u32, rhs: u32) -> bool {
    (lhs.wrapping_sub(rhs) as i32) < 0
}

pub(in crate::tcp) fn packet_sequence_len(packet: &ParsedTcpPacket) -> u32 {
