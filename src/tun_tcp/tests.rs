#![cfg(test)]
    ...
    use crate::transport::{AnyWsStream, TcpShadowsocksReader, TcpShadowsocksWriter, UpstreamTransportGuard};
    ...
    async fn tun_tcp_client_fin_transitions_through_last_ack() {
        ...
        assert!(matches!(
            ...
            super::TcpFlowStatus::CloseWait | super::TcpFlowStatus::LastAck
        ));
