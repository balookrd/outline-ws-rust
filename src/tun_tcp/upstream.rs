...
pub(super) async fn do_tcp_ss_setup(
...
pub(super) async fn do_tcp_ss_setup_socket(
...
pub(super) fn ip_to_target(ip: std::net::IpAddr, port: u16) -> TargetAddr {
    match ip {
        std::net::IpAddr::V4(ip) => TargetAddr::IpV4(ip, port),
        std::net::IpAddr::V6(ip) => TargetAddr::IpV6(ip, port),
    }
}

pub(super) fn ip_family_from_version(version: crate::tun_wire::IpVersion) -> &'static str {
    match version {
        crate::tun_wire::IpVersion::V4 => "ipv4",
        crate::tun_wire::IpVersion::V6 => "ipv6",
    }
}
